...
git remote add origin https://alanmugiwara:%TOKEN%@github.com/SEU-USER/SEU-REPOSITORIO-REMOTO.git
...
if %errorlevel% neq 0 (
    echo Falha ao atualizar o repositório: SEU-REPOSITORIO-LOCAL
) else (
    echo Repositório atualizado com sucesso: SEU-REPOSITORIO-LOCAL
)
